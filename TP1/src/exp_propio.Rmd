...
Wine:
Este dataset es el que parece verse menos afectado por la eliminacion de variables, si comparamos el rendimiento del dataset original con el dataset reducido no parece existir ninguna diferencia de comportamiento. 
